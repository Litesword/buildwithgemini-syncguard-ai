...
def get_session_service():
    ...
    if agent_engine_id := os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID"):
        ...
        return VertexAiSessionService(
            project="qwiklabs-gcp-03-79d86c84d36d",
...
def get_memory_service():
    """Process-wide memory service: Vertex AI Memory Bank when engine ID is set, else in-memory."""
    agent_engine_id = os.environ.get("MEMORY_BANK_ID") or os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or "3129344233069084672"
    if agent_engine_id:
